                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr>
                            ...
                            <div class="tooltip-demo">
                                <th class="select-filter" scope="col" data-toggle="tooltip" data-placement="top" title="Staff member’s username." data-original-title="Tooltip on top"><i class="fa fa-lg fa-info-circle" style="padding-right: 10px"></i>Name</th>
                            </div>
                            <th>Practice Name</th>
                    ...
                    <tbody>
                         <?php foreach ($users as $key => $user): ?>
                                <tr>
                                    ...
                                    <td><?php if(isset($indexEvent[$user->id]['business']['name'])){
                                                    echo $indexEvent[$user->id]['business']['name'];
                                                }else{
                                                    echo 'N/A';
                                                } ?>            
                                    </td>
